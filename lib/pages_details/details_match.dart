...
class _MatchDetailsPageState extends State<MatchDetailsPage>
  ...
  Widget _playerStatsTab(bool isDark, Color primary, Color cardBg, Color textPri,
    ...
    return ListView.builder(
      ...
      itemBuilder: (_, i) {
        final s = stats[i];
        final player = Hive.box<Player>('players').values.firstWhere(
          (p) => p.backendId == s.playerId,
          orElse: () => Player(
              name: 'Unknown', position: 'N/A', age: 0, nationality: '', number: 0),
        );
        ...
        return GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(14),
              border: Border.all(
                  color: isMvp ? const Color(0xFFFFD700).withValues(alpha: 0.4) : divider),
              boxShadow: isMvp
                  ? [
                      BoxShadow(
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        '${s.goals ?? 0} Goals · ${s.assists ?? 0} Assists · ${s.topSpeed?.toStringAsFixed(1) ?? '0.0'} km/h',
                        style: GoogleFonts.inter(fontSize: 12, color: textSec),
                      ),
                    ],
                  ),
